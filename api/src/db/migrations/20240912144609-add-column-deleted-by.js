...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Comment" ADD CONSTRAINT "Comment_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."Consultation" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Consultation" ADD CONSTRAINT "Consultation_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."Group" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Group" ADD CONSTRAINT "Group_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."MedicalFile" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."MedicalFile" ADD CONSTRAINT "MedicalFile_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."Passage" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Passage" ADD CONSTRAINT "Passage_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."Person" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Person" ADD CONSTRAINT "Person_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."Place" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Place" ADD CONSTRAINT "Place_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."RelPersonPlace" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."RelPersonPlace" ADD CONSTRAINT "RelPersonPlace_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."Rencontre" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Rencontre" ADD CONSTRAINT "Rencontre_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."Report" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Report" ADD CONSTRAINT "Report_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."Territory" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Territory" ADD CONSTRAINT "Territory_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."TerritoryObservation" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."TerritoryObservation" ADD CONSTRAINT "TerritoryObservation_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
    await queryInterface.sequelize.query(`ALTER TABLE "mano"."Treatment" ADD COLUMN "deletedBy" UUID;`);
    await queryInterface.sequelize.query(
      `ALTER TABLE "mano"."Treatment" ADD CONSTRAINT "Treatment_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "mano"."User"("_id") ON DELETE SET NULL;`
    );
  },
