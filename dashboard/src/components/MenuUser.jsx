...
const MenuUser = ({ isDrawerCollapsed, className = "" }) => {
  ...
  return (
    <Menu as="div" className={["tw-relative tw-inline-block tw-text-left tw-z-50", className].join(" ")}>
      <MenuButton
        className={[
          "tw-inline-flex tw-flex-1 tw-items-center tw-justify-start tw-gap-x-1.5 tw-rounded-lg tw-border tw-px-1.5 tw-text-xs tw-font-normal tw-text-white tw-text-left focus:tw-outline-none tw-py-2 tw-max-w-full tw-w-full",
      ...
      >
        ...
        <div className="tw-border-t tw-border-gray-200 tw-py-1 tw-flex tw-flex-col">
          <MenuItem>
            <Link
              to="/account"
              className="border-2 tw-flex tw-items-center tw-px-4 tw-py-2 tw-text-sm tw-whitespace-nowrap data-[focus]:tw-bg-gray-100 data-[focus]:tw-text-gray-900"
            >
              Mon compte
            </Link>
          </MenuItem>
