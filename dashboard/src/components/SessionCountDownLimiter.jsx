...
import { checkEncryptedVerificationKey, derivedMasterKey, resetOrgEncryptionKey } from "../services/encryption";
    ...
    >
      ...
      <ModalBody>
        <form
          ...
          onSubmit={async (e) => {
            e.preventDefault();
            const organisationKey = await derivedMasterKey(encryptionKey.trim());
