...
import { TODO } from "../../atoms/actions";
import ButtonCustom from "../../components/ButtonCustom";
import { currentTeamState, organisationState, teamsState, userState } from "../../atoms/auth";
import { flattenedServicesSelector, reportsState } from "../../atoms/reports";
import { useAtomValue } from "jotai";
import { passagesState } from "../../atoms/passages";
import useTitle from "../../services/useTitle";
import SelectTeamMultiple from "../../components/SelectTeamMultiple";
import { arrayOfitemsGroupedByPersonSelector, onlyFilledObservationsTerritories } from "../../atoms/selectors";
...
const getPeriodTitle = (date, nightSession) => {
  ...
  return (
    <>
      ...
      <span className="tw-m-0 tw-text-center tw-text-xs tw-text-gray-500 tw-ml-2">
...
function useItemsForReports({ period, viewAllOrganisationData, selectedTeamsObjectWithOwnPeriod }) {
  ...
  return useMemo(() => {
    ...
    for (let person of allPersons) {
      ...
      const createdDate = person.followedSince || person.createdAt; // TODO: Ce nom de variable est trompeur
