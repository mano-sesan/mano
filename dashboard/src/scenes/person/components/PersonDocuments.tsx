...
import { encryptAction, prepareActionForEncryption } from "../../../recoil/actions";
  ...
  return (
    <DocumentsModule
      ...
      onDeleteDocument={async (document) => {
        ...
        await api.delete(document.downloadPath ?? `/person/${_person._id}/document/${document.file.filename}`);
