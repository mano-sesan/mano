...
test("test", async ({ page }) => {
  ...
  await clickOnEmptyReactSelect(page, "person-select-gender", "Femme");
  ...
  await page.getByLabel("Structure de suivi social").click(); // Aucune
  await page.getByLabel("Structure de suivi social").fill("social");
  await clickOnEmptyReactSelect(page, "person-custom-select-avec-animaux", "Oui");
  await clickOnEmptyReactSelect(page, "person-custom-select-hébergement", "Oui");
  await clickOnEmptyReactSelect(page, "person-custom-select-type-dhébergement", "Chez un tiers");
  await clickOnEmptyReactSelect(page, "person-custom-select-nationalité", "Hors UE");
  ...
  await clickOnEmptyReactSelect(page, "person-custom-select-couvertures-médicales", "AME");
  ...
  await page.locator('[data-test-id="Autres pseudos\\: \\"\\" ➔ \\"test pseudo\\""]').waitFor({ state: "visible" });
  await page.locator('[data-test-id="Autres pseudos\\: \\"\\" ➔ \\"test pseudo\\""]').click();
  await page.locator('[data-test-id="Genre\\: \\"Femme\\" ➔ \\"Homme\\""]').waitFor({ state: "visible" });
  await page.locator('[data-test-id="Genre\\: \\"Femme\\" ➔ \\"Homme\\""]').click();
  await page.locator('[data-test-id="Numéro de sécurité sociale\\: \\"\\" ➔ \\"082\\""]').waitFor({ state: "visible" });
