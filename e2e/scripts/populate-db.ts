  ...
  for (let i = 1; i < 12; i++) {
    ...
    await client.query(
      `INSERT INTO mano."Organisation" (
        ...
        '[{"groupTitle":"Tous mes services","services":[{"name":"Café","enabled":true,"enabledTeams":[]},{"name":"Douche","enabled":true,"enabledTeams":[]},{"name":"Repas","enabled":true,"enabledTeams":[]},{"name":"Kit","enabled":true,"enabledTeams":[]},{"name":"Don chaussures","enabled":true,"enabledTeams":[]},{"name":"Distribution seringue","enabled":true,"enabledTeams":[]}]}]',
        true,
        '{"Ma première collab"}',
