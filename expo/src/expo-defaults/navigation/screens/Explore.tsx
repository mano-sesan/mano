...
import { Collapsible } from "@/expo-defaults/components/Collapsible";
import { ExternalLink } from "@/expo-defaults/components/ExternalLink";
import ParallaxScrollView from "@/expo-defaults/components/ParallaxScrollView";
import { ThemedText } from "@/expo-defaults/components/ThemedText";
import { ThemedView } from "@/expo-defaults/components/ThemedView";
  ...
  return (
    ...
    >
      ...
      <Collapsible title="React Navigation">
        <ThemedText>
          This app has two screens: <ThemedText type="defaultSemiBold">src/navigation/screens/Home.tsx</ThemedText> and{" "}
          <ThemedText type="defaultSemiBold">src/navigation/screens/Explore.tsx</ThemedText>
        </ThemedText>
        <ThemedText>
          The entry point file in <ThemedText type="defaultSemiBold">src/navigation/index.tsx</ThemedText> sets up the tab navigator.
        </ThemedText>
