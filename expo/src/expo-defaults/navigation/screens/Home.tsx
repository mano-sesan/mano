...
import { HelloWave } from "@/expo-defaults/components/HelloWave";
  ...
  return (
    ...
    >
      ...
      <ThemedView style={styles.stepContainer}>
        ...
        <ThemedText>
          Edit <ThemedText type="defaultSemiBold">src/navigation/screens/Home.tsx</ThemedText> to see changes. Press{" "}
