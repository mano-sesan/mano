...
const MultiCheckBoxes = ({ label, source, values, onChange, editable, emptyValue, allowCreateOption }: MultiCheckBoxesProps) => {
  ...
  const onCheck = ({ _id: newValue }: { _id: string }) => {
