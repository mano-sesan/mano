...
const Title = styled(MyText)<{ color?: string }>`
  font-size: 25px;
...
type Styles = {
  wrapper: (parentScroll: ScreenTitleProps["parentScroll"], forceTop: ScreenTitleProps["forceTop"]) => ViewStyle;
  titleContainer: (parentScroll: ScreenTitleProps["parentScroll"], forceTop: ScreenTitleProps["forceTop"]) => ViewStyle;
  color: (backgroundColor: ScreenTitleProps["backgroundColor"]) => ViewStyle;
  container: (forceTop: ScreenTitleProps["forceTop"]) => ViewStyle;
  buttonsContainer: ViewStyle;
  buttonsContainerFixed: ViewStyle;
  buttonContainer: (show: boolean) => ViewStyle;
  titleCaptionContainer: ViewStyle;
};
