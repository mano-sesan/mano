...
type OrganisationDesactiveeProps = NativeStackScreenProps<LoginStackParamsList, "ORGANISATION_DESACTIVEE">;

const OrganisationDesactivee = ({ navigation }: OrganisationDesactiveeProps) => {
  return (
